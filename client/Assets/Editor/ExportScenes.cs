...
public class ExportScenesManager
{
        ...
        foreach (var item in selection)
        {
            ...
            if (go)
                foreach (Transform p in go.transform)
                {
                    ...
                    {
                        if (p.GetComponent<ParticleSystem>().GetComponent<Renderer>() && p.GetComponent<ParticleSystem>().GetComponent<Renderer>().sharedMaterial)
                        {
                            if (!p.GetComponent<ParticleSystem>().GetComponent<Renderer>().sharedMaterial.mainTexture)
                            {
    ...
    class Md5Update
    {
        ...
        public void SavePkgVersion()
        {
            ...
            else
            {
                ...
                PackageUrl = "http://192.168.44.251/package/";
                ApkUrl = "http://192.168.44.251/Mogo.apk";
                PackageMd5List = "http://192.168.44.251/packagemd5.xml";
            }
    ...
    public static void TestAssetbundle()
    {
        ...
        //Debug.Log("MogoResource: " + m_assetBundleDic.Count + " m_allRecources.Count: " + m_allRecources.Count);
    }
