...
public class SoundManager
{
    ...
    static SoundManager()
    {
        //Debug.Log("ConstructSoundManager");
    }
    ...
    {
        //Debug.Log("FreeSoundEnvironment");
    ...
    {
        //Debug.Log("SaveVolume: " + soundVolume + " " + musicVolume);
    ...
    public static void LoadAudioClip(int soundID, Action<UnityEngine.Object> action = null)
    {
        ...
        {
            //Debug.Log("Sound ID " + soundID + " not exist");
            return;
        }
    ...
    public static void UIUpPlaySound(string name)
    {
        ...
        //Debug.Log("UIUpPlaySound");
        if (!UIMapData.soundIDUINameMap.ContainsKey(name))
        {
            //Debug.Log("Name " + name + " not exist in soundIDUINameMap");
            PlaySoundByID(6);
            return;
        }
    ...
    public static void PlaySoundByObject(UnityEngine.Object clipObject)
    {
		if(clipObject==null)
		{
			//Debug.LogError("animation clip Object is null!");
			return ;
		}
    ...
    {
        //Debug.Log("PlayBackgroundMusic Check");
    ...
    {
        //Debug.Log("PlayMusicByObject: " + clipObject + " " + MusicVolume);
    ...
    public static void StopBackgroundMusic()
    {
        ...
        if (defaultMusicSource != null)
        {
            //Debug.Log("defaultSource" + defaultSource.gameObject.name);
