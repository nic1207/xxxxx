...
namespace Mogo.AI
{
    ...
    public class HasFightTarget : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "HasFightTarget:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "HasFightTarget:" + "false");
			}
    ...
    public class InSkillRange : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
			{
                //Debug.Log("AI:" + "InSkillRange:" + m_iSkillId  + " true");
			}
            else
			{
                //Debug.Log("AI:" + "InSkillRange:" + m_iSkillId + " false");
			}
    ...
    public class InSkillCoolDown : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
			{
                //Debug.Log("AI:" + "InSkillCoolDown:" + m_iSkillId + " true");
			}
            else
			{
                //Debug.Log("AI:" + "InSkillCoolDown:" + m_iSkillId + " false");
			}
    ...
    public class LastCastIs : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
			{
                //Debug.Log("AI:" + "LastCastIs:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "LastCastIs:" + "false");
			}
    ...
    public class ISRest : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "ISRest:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "ISRest:" + "false");
			}
    ...
    public class ISCD : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "ISCD:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "ISCD:" + "false");
			}
    ...
    public class IsEventMoveEnd : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventMoveEnd:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventMoveEnd:" + "false");
			}
    ...
    public class IsEventBorn : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventBorn:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventBorn:" + "false");
			}
    ...
    public class IsEventAvatarDie : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventAvatarDie:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventAvatarDie:" + "false");
			}
    ...
    public class IsEventCDEnd : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventCDEnd:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventCDEnd:" + "false");
			}
    ...
    public class IsEventRestEnd : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventRestEnd:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventRestEnd:" + "false");
			}
    ...
    public class IsEventBeHit : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventBeHit:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventBeHit:" + "false");
			}
    ...
    public class IsEventAvatarPosSync : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
			...
			{
                //Debug.Log("AI:" + "IsEventAvatarPosSync:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsEventAvatarPosSync:" + "false");
			}
    ...
    public class CmpEnemyNum : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt == true)
			{
                //Debug.Log("AI:" + "CmpEnemyNum:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "CmpEnemyNum:" + "false");
			}
            return rnt;
        }
    }
    ...
    public class IsTargetCanBeAttack : ConditionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt == true)
			{
                //Debug.Log("AI:" + "IsTargetCanBeAttack:" + "true");
			}
            else
			{
                //Debug.Log("AI:" + "IsTargetCanBeAttack:" + "false");
			}
            return rnt;
        }
    }
    ...
    public class CmpSkillUseCount : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt == true)
            {
                //Debug.Log("AI:" + "CmpSkillUseCount:" + _skillId + " true");
            }
            else
            {
                //Debug.Log("AI:" + "CmpSkillUseCount:" + _skillId + "false");
            }
            return rnt;
        }
    }
    ...
    public class LastLookOnModeIs : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Debug.Log("AI:" + "LastLookOnModeIs:" + "true");
            }
            else
            {
                //Debug.Log("AI:" + "LastLookOnModeIs:" + "false");
            }
    ...
    public class CmpLastSkillCoord : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Debug.Log("AI:" + "CmpLastSkillCoord:" + "true");
            }
            else
            {
                //Debug.Log("AI:" + "CmpLastSkillCoord:" + "false");
            }
    ...
    public class CmpTargetDistance : ConditionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            {
                //Debug.Log("AI:" + "CmpTargetDistance:" + "false");
                return false;
            }
            ...
            if (rnt)
            {
                //Debug.Log("AI:" + "CmpTargetDistance:" + "true");
            }
            else
            {
                //Debug.Log("AI:" + "CmpTargetDistance:" + "false");
    ...
    public class IsPatrolCD : ActionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsPatrolCD:" + "true");
            }
            else
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsPatrolCD:" + "false");
            }
            return rnt;
        }
    }
    ...
    public class IsAngerFull : ActionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsAngerFull:" + "true");
            }
            else
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsAngerFull:" + "false");
            }
            return rnt;
        }
    }
    ...
    public class IsPowerFX : ActionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsPowerFX:" + "true");
            }
            else
            {
                //Mogo.Util.Debug.LogError("AI:" + "IsPowerFX:" + "false");
            }
            return rnt;
        }
    }
