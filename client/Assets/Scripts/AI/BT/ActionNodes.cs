...
namespace Mogo.AI
{
    ...
    public class ChooseCastPoint : ActionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt == true)
            {
                //Debug.Log("AI:" + "ChooseCastPoint:true");
            }
            else
            {
                //Debug.Log("AI:" + "ChooseCastPoint:false");
            }
            return rnt;
        }
    }
    ...
    public class CastSpell : ActionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            //Debug.Log("AI:" + "CastSpell:" + m_iSkillId);
    ...
    public class SelectAutoFightMovePoint : ActionNode
    {
        public override bool Proc(EntityParent theOwner)
        {
            //Debug.Log("AI:" + "SelectAutoFightMovePoint");
    ...
    public class Patrol : ActionNode
    {
        ...
        public override bool Proc(EntityParent theOwner)
        {
            ...
            if (rnt)
            {
                //Mogo.Util.Debug.LogError("AI:" + "PatrolAction" + "true");
            }
            else
            {
                //Mogo.Util.Debug.LogError("AI:" + "PatrolAction" + "false");
            }
            return rnt;
        }
    }
