...
public class SocietyUIViewManager : MogoUIBehaviour
{
    ...
    void Awake()
    {
        ...
        Debug.Log(m_camFriendGridList.name);
    ...
    {
        Debug.Log("RecvAllBless OnRecvAllBlessBtnUp");
        //ClearFriendGridList();
    ...
    {
        Debug.Log("OnMessageDialogQuitUp Quit");
        ClearMessageDialogList();
    ...
    {
        Debug.Log("OnReturnMessageBtnUp Return");
        m_btnSendMessageBtn.id = i;
        string name = FriendManager.Instance.GetFriendInfo(i).name;
        SetReturnMessageFriendName(name);
        ShowMessageDialog(false);
    ...
    {
        Debug.Log("OnReturnMessageDialogQuitUp Quit");
        ShowReturnMessageDialog(false);
        ShowMessageDialog(false);
    ...
    {
        Debug.Log("Send " + m_inputReturnMessage.text);
    ...
    {
        //Debug.Log("Delete " + i + " " + m_mailGridToMailID[m_iCurrentDownMailGrid]);
            ...
            () =>
            {
                ...
                if (m_OneKeyGetBlessRewardList.GetComponent<MogoListImproved>().DataList.Count > 0)
                {
                    foreach (TDBID id in blessFriendList)
                    {
                        ...
                        //Debug.LogError("AddOneKeyGetBlessListUnit:" + fd.name);
