...
public class NormalMainUILogicManager : UILogicManager
{
    ...
    //    //Debug.Log(ltSS + " " + ltSSS);
    //    Debug.Log(ltSS.Count);
    ...
    //                    {
    //                        Debug.Log("Initative Not Open");
    //                    }
    //                    else if ((string)ltSSS[i.ToString()] == "0")
    //                    {
    //                        Debug.Log("Initative No Skill");

    //                    }
    //                    else
    //                    {
    //                        Debug.Log("Initative Have Skill");
    ...
    {
        //Debug.Log("OnChargeRewardIconUp");
        EventDispatcher.TriggerEvent(EntityMyself.ON_END_TASK_GUIDE);
    ...
    {
        //Debug.Log("AutoTask " + MogoWorld.thePlayer.CurrentTask);
