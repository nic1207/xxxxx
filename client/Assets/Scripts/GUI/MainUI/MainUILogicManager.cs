...
public class MainUILogicManager : UILogicManager
{
    ...
    public void SetBossMessageInit(EntityParent boss, int bloodNum)
    {
        ...
        // Debug.Log("Init boss hp: " + boss.hp);
        // if (boss is EntityMercenary)
        //    Debug.Log("Init boss hpBase: " + (boss as EntityMercenary).MonsterData.hpBase);
        // Debug.Log("Init boss curHp: " + boss.curHp);       
        ...
        if (defaultBlood == 0)
            Debug.LogError("defaultBlood == 0: " + boss.ID + " " + boss.GameObject.name);
    ...
    {
        //Mogo.Util.Debug.LogError("FlushBossBlood boss hp: " + boss.hp);
        // if (boss is EntityMercenary)
        //     Mogo.Util.Debug.LogError("FlushBossBlood boss hpBase: " + (boss as EntityMercenary).MonsterData.hpBase);
        // Mogo.Util.Debug.LogError("FlushBossBlood boss curHp: " + boss.curHp);
