...
public class MogoFXManager
{
    ...
    {
        //Debug.Log("Trying To ReMoveShadow");
    ...
    public void GetHit(GameObject goTarget, float lastTime = 0.2f, HitColorType hct = HitColorType.HCT_WHITE)
    {
        ...
        for (int i = 0; i < smrList.Length; ++i)
        {
            ...
            {
                //Debug.Log(string.Concat("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ", smrList[i].material.shader.name));
            }
            else
            {
                //Debug.LogError("@@@@@@@@@@@@@@@@@@@@@@@@@@@ HitShader is NULL");
    ...
    public void UpdatePointerToTarget(Vector3 targetPos)
    {
        ...
        //Debug.Log("UpdatePointerToTarget " + targetPos);
    ...
    public void AttachUIFX(int fxId, Camera RelatedCamera, float xOffset = 0, float yOffset = 0, float zOffset = 0, GameObject widget = null, string fxName = "")
    {
        ...
        //Debug.Log(fxPrefab + " !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " + programType);
        ...
        if (logicType == 1)
        {
            ...
            {
                //Debug.Log("Run Herereereereerererererererererereeer");
                if (duration == 0)
                {
                    //Debug.Log(parentTrans.name);
    ...
    {
        //Debug.Log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ Trying to Remove EnenmyInScreen " + id); 
        //Debug.Log("Befor Remove " + m_listEnemyObj.Count + " " + m_listEnemyScreenObj.Count);
        for (int i = 0; i < m_listEnemyObj.Count; ++i)
        {
            if (m_listEnemyObj[i] == null)
            {
                //Debug.Log("m_listEnemyObj " + i + " is NULL");
        ...
        for (int i = 0; i < m_listEnemyScreenObj.Count; ++i)
        {
            ...
            {
                //Debug.Log("m_listEnemyScreenObj " + i + " is NULL");
        ...
        //Debug.Log("After Remove " + m_listEnemyObj.Count + " " + m_listEnemyScreenObj.Count);
    }
    ...
    public void UpdateEnemyInScreen()//�˷������Ż����Ƕ�if elseû����
    {
        ...
        //Debug.Log(m_listEnemyScreenObj.Count + " " + m_listEnemyObj.Count  );
        for (int i = 0; i < m_listEnemyScreenObj.Count; ++i)
        {
            //Debug.Log(m_listEnemyScreenObj[i].name);
            if (m_listEnemyObj.Count > i && m_listEnemyObj[i] != null && m_listEnemyScreenObj[i] != null && Camera.main != null)
            {
                //Debug.Log(m_listEnemyScreenObj[i].name + " In");
                ...
                //Debug.Log(m_listEnemyObj.Count + " " + m_listEnemyObj[i].name + " " + pos);
                ...
                else
                {
                    ...
                    {
                        //Debug.Log(m_listEnemyScreenObj[i].name + " isFalse");
                        if (m_listEnemyScreenObj[i].activeSelf)
