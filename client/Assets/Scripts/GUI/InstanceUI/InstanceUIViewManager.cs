...
public class InstanceUIViewManager : MonoBehaviour
{
    ...
    {
        //Debug.Log("levelID            " + levelID + "starNum             " + starNum);
    ...
    public void SetInstanceRewardListItem(List<ItemParent> list)
    {
        ...
        //Debug.Log(list.Count + " " + m_RewardItemNum + ".........................");
    ...
    public void AddRewardItem(int num, Action act = null)
    {
        ...
        for (int i = 0; i < num; ++i)
        {
            ...
            AssetCacheMgr.GetUIInstance("InstanceRewardItem.prefab", (prefab, guid, go) =>
            {
                ...
                //Debug.Log("AddRewardItem !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " + index + " " + num);
    ...
    public void AddRewardItem<T, U>(int num, Action<T, U> act, T arg1, U arg2)
    {
        ...
        for (int i = 0; i < num; ++i)
        {
            ...
            AssetCacheMgr.GetUIInstance("InstanceRewardItem.prefab", (prefab, guid, go) =>
            {
                ...
                //Debug.Log("AddRewardItem<TU> !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " + index + " " + num);
    ...
    public void SetInstanceLevelEnable(int gridId, bool enable)
    {
        ...
        //Debug.Log("Setting InstanceLevelGridEnable!!!!!!!!!!!!!!!!!!!!");
    }
    ...
    void Awake()
    {
        ...
        //    Debug.Log("Adding InstanceLevelGrid !!!!!!!!!!!!1");
        //}
    ...
    void Initialize()
    {
        ...
        //Debug.Log("InstanceUIViewManager Initialize@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    ...
    {
        //Debug.Log("InstanceUIViewManager Release@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
    ...
    void Update()
    {
        ...
        if (m_bBeginCount)
        {
            ...
            {
                //Debug.Log("m_fCurrentTime >= LEAVEINSTANCETIME + LEAVEINSTANCEWAITTIME");
                m_bBeginCount = false;
            ...
            //{
            //    Debug.Log("m_fCurrentTime >= LEAVEINSTANCEWAITTIME && !isCountingTime");
            //    isCountingTime = true;
            //}
