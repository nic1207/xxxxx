...
public class NewLoginUIViewManager : MogoUIBehaviour
{
    ...
    {
        //Debug.Log("CreateCharcterServerBtnUp");
    ...
    {
		//Debug.Log("OnChooseCharacterUIEnterBtnUp()");
    ...
    {
		//Debug.Log("OnChooseCharacterUIDeleteBtnUp()");
    ...
    {
		Debug.Log("OnChooseCharacterUIServerBtnUp()");
        if (ChooseCharacterUIServerBtnUp != null)
            ChooseCharacterUIServerBtnUp();
    }
    ...
    {
		Debug.Log("OnChooseCharacterCommunityBtnUp()");
    }
    ...
    {
		Debug.Log("OnCreateCharacterDetailUIRandomBtnUp()");
    ...
    {
		Debug.Log("OnChooseServerUILatelyLogBtn0Up()");
    }

    void OnChooseServerUILatelyLogBtn1Up()
    {
		Debug.Log("OnChooseServerUILatelyLogBtn1Up()");
    }

    void OnCreateCharacterUIBackBtnUp()
    {
		Debug.Log("OnCreateCharacterUIBackBtnUp()");
    ...
    {
		Debug.Log("OnRecommendServerSwitchUp()");
    }
