...
public class MogoUIManager : MonoBehaviour
{
        ...
        if (m_TaskUI == null)
        {
            if (!IsTaskUILoaded)
            {
                ...
                AssetCacheMgr.GetUIInstance("TaskUI.prefab", (prefab, guid, go) =>
                {
                    ...
                    //Debug.Log("Before UI is " + m_CurrentUI.name + "!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    private void TruelyShowMogoInstanceRebornUI(bool isShow = true, Action act = null)
    {
        ...
        {
            Debug.Log("TruelyShowMogoInstanceReborn.......................CurrentUI..................m_goInstanceRebornUI");
    ...
    private void TruelyShowMogoInstanceRebornNoneDropUI(bool isShow = true, Action act = null)
    {
        ...
        {
            Debug.Log("TruelyShowMogoInstanceRebornNoneDrop.......................CurrentUI..................m_goInstanceRebornNoneDropUI");
    ...
    private void TruelyMogoOperatingUI(int firstShow = 0, Action action = null)
    {
                ...
                AssetCacheMgr.GetUIInstance("OperatingUI.prefab",
                    (prefab, guid, go) =>
                    {
                        ...
                        if (CurrentUI != m_OperatingUI)
                        {
                            ...
                            {
                                case 1:
                                    //Debug.Log("firstShow SwitchTimeLimitActivityUI");
                                    SwitchTimeLimitActivityUI();
                                    break;
                                case 2:
                                    //Debug.Log("firstShow SwitchLoginRewardUI");
                                    SwitchLoginRewardUI();
                                    break;
                                case 3:
                                    //Debug.Log("firstShow SwitchAttributeRewardUI");
                                    SwitchAttributeRewardUI();
                                    break;
                                default:
                                    //Debug.Log("firstShow SwitchChargeRewardUI");
        ...
        else
        {
            if (CurrentUI != m_OperatingUI)
            {
                ...
                Debug.Log(MogoWorld.thePlayer.IsAchiementHasOpen + "" + MogoWorld.thePlayer.IsTimeLimitEventHasOpen);
    ...
    public void TryingSetSpriteName(string iconName,UISprite sp)
    {
        ...
        else
        {
            ...
            else if (iconName.Length >= 9 && iconName.Substring(0, 9) == "icon_mage")
            {
                ...
                Debug.Log("Damn !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! " + iconName.Substring(iconName.Length - 1, 1));
                switch (lastCharacter)
                {
                    case "1":
                    case "2":
    ...
    public UIAtlas GetAtlasByIconName(string iconName)
    {
        ...
        else
        {
            ...
            Debug.Log("Atlas Do Not Contain the Sprite !!! Please Contact Mr.Deng " + iconName);
            return CommonAtlas;
        }
    }
    ...
    public void ReleaseUIResources()
    {
        ...
        //    Debug.Log("Release CommonAtlas!!!!!!!!!!!1");
        //}
        ...
        //    Debug.Log("Release SpecifyAtals !!!!!!!!!!!!!!!!!!!");
        //}
    ...
    public void SecondPreLoadUIResources()
    {
        ...
        //{
        //    sw.Stop();
        //    Debug.LogInfo("SecondPreLoadUIResources: " + sw.ElapsedMilliseconds);
        //});
    }
    ...
    public void PreLoadResource(string resName, Action<UnityEngine.Object> callBack)
    {
        ...
        {
            //sw.Stop();
            //Debug.LogInfo("PreLoadResource: " + resName + " " + sw.ElapsedMilliseconds);
            if (callBack != null)
                callBack(obj);
        });
    }
    ...
    {
        Debug.Log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@ ReleaseMogoUI " + (InstanceUIViewManager.Instance == null));
        if (InstanceUIViewManager.Instance != null)
        {
