...
public class AssistantUILogicManager
{
    ...
    {
        Debug.Log("LevelUpSkillResp " + errorCode);
    ...
    {
        Debug.Log("LevelUpMarkResp " + errorCode);
    ...
    {
        Debug.Log("ClientDragSkillResp " + errorCode);
        ...
        {
            Debug.Log("DragSkillResp Error!!! ErrorCode = " + errorCode);
        }
    }

    void OnClientDragMarkResp(UInt32 markId, UInt32 gridId, byte errorCode)
    {
        Debug.Log("ClientDragmarkResp " + errorCode);
        ...
        {
            Debug.Log("DragMarkResp Error!!! ErrorCode = " + errorCode);
        }
    }
