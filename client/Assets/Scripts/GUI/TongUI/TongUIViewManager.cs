...
public class TongUIViewManager : MogoUIParent
{
    ...
    private void InitButtonAction()
    {
        ...
        {
            Debug.Log("MyTongPresenterListBtnRefresh");
        ...
        {
            Debug.Log("MyTongPresenterListBtnInvite");
        ...
        {
            Debug.Log("MyTongSkillListGridUpgradeBtn");
    ...
    private string GetPageNumStr(MyDragableCamera camera, int pageNum)
    {
        ...
        //Debug.Log("camera.GetCurrentPage():" + camera.GetCurrentPage() + ",pageNum:" + pageNum);
    ...
    {
        Debug.Log("OnListPageMove:" + lbl.name + ",count:" + count + ",gap:" + gap + ",pageHeight:" + pageHeight);
