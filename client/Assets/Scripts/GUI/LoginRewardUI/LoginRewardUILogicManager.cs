...
public class LoginRewardUILogicManager
{
    ...
    public void Initialize()
    {
        ...
        //Debug.Log("defaultLoginCircleDays: " + defaultLoginCircleDays);
        // Debug.Log("defaultLoginMarketCircleDay: " + defaultLoginMarketCircleDay);
    ...
    public void SetGridInfo(int dataID, RewardLoginData data)
    {
        ...
        foreach (var item in items)
        {
            if (ItemParentData.GetItem(item.Key) != null)
            {
                ...
                Debug.Log("Item" + item.Key + " Not Exist");
        }
        ...
        if (true)
        {
            //Debug.Log("loginMarketCircleDay" + loginMarketCircleDay);
            ...
            //{
                ...
                if (LoginMarketData.dataMap.ContainsKey(tempTime.Day))
                {
                    ...
                    {
                        Debug.Log("Item " + marketData.itemId + " Not Exit");
                    }
        ...
        //Debug.Log("isOldServer" + ld.ListLeftItem.Count);
    ...
    protected void ShowButton()
    {
        ...
        {
            //Debug.Log("ShowLoginGrid IsLoginRewardHasGot True");
        ...
        {
            //Debug.Log("ShowLoginGrid IsLoginRewardHasGot False");
    ...
    {
        //Debug.Log("OperationSystem LogInGetReward" + lastPage);
    ...
    {
        //Debug.Log("OperationSystem LogInBuy" + lastPage);
