...
public class DailyTaskSystemController : IDailyTaskController
{
    ...
    public void ShowNotification()
    {
        ...
        else
        {
            ...
            if (null == m_DailyTaskIcon) Debug.LogError("ShowNotification m_DailyTaskIcon is null!");
        }
    }
    ...
    {
        Debug.Log("DailyTaskController Jump to :line 94:" + nParam);
        ...
        switch (nParam)
        {
            ...
            case 25:
                ...
                break;
            default:
                Debug.LogError("cannot jump to id " + nParam);
                break;
        }
    }
    ...
    void AllPanelIsReady()
    {
        ...
        //Debug.Log("show daily task panel!");
