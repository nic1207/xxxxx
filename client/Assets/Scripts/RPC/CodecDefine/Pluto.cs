...
namespace Mogo.RPC
{
    ...
    public abstract class Pluto
    {
        ...
        public static Pluto Decode(Byte[] data)
        {
            ...
            //Debug.Log("pluto decode=" + str+"str length="+str.Length+"data length="+data.Length);
            ...
            //Debug.Log("unLen=" + unLen + "msgid=" + msgId);
            //Debug.Log("msg_id: " + msgId);
			//Debug.Log("Pluto.Decode() msg_id=" + msgId);
            switch (msgId)
            {
                ...
                case MSGIDType.CLIENT_ENTITY_ATTACHED:
                    //Debug.Log("start entity attached");
