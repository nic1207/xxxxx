...
public class ActorParent : MonoBehaviour
{
    ...
    virtual public void ActChange()
    {
        ...
        {//动作变换
            ...
            {
                SkillAction a = null;
				if (GetEntity() !=null && GetEntity().currSpellID != -1 &&
    ...
    {
		//Debug.Log("InitEquipment() name:" + transform.name + ",vocation:" + (int)GetEntity().vocation);
    ...
    protected void PutOnNakedEquip()
    {
        ...
        foreach (int id in m_nakedEquipList)
        {
            ...
            {
				Debug.LogError("cannot find equipData:" + id);
            }
    ...
    private void AddEquidMethod2(EquipData equipData)
    {
        ...
        {
			Debug.Log("!m_equipGoDic.ContainsKey(equipData.id):" + equipData.id);
            return;
        }
        ...
        if (equipPart == null)
        {
			Debug.Log("can not find slot:" + equipData.slot[0] + ",equipId:" + equipData.id + ",vocation:" + GetEntity().vocation);
            return;
        }
    ...
    private void AddEquidMethod1(EquipData equipData)
    {
		...
		//Debug.Log("clear");
        //}
		//Debug.Log("equipData.prefabPath.ccount:" + equipData.prefabPath.Count);
        ...
        for (int i = 0; i < equipData.prefabPath.Count; i++)
        {
            ...
            if (equipGo == null)
            {
				Debug.Log("equip load fail!:" + equipData.id);
				//Debug.Log("equip load fail!");
                ccount++;
                return;
            }
            ...
            if (equipPart == null)
            {
				//Debug.Log("cannot find equip slot!:" + equipData.slot[ccount]);
				Debug.Log("cannot find equip slot!");
                ccount++;
                return;
            }

			//Debug.Log("equipPart:" + equipPart.name);
            //Transform tempTransform;
            //if ((tempTransform = equipPart.FindChild(equipGo.name)) != null)
            //{
			//    Debug.Log("已经装备：" + equipGo.name);
			...
			//Debug.Log("load done:" + equipGo.name);
            ccount++;
			//Debug.Log("ccount:" + ccount);

            if (ccount == equipData.prefabPath.Count)
            {
				//Debug.Log("ccount == equipData.prefabPath.Count");
		...
		//Debug.Log("AddEquidMethod1() equip done:" + currentEquip.id);
        ...
        //    {
		//        Debug.Log(equipData.prefabPath.Count);
        //    }
		//    Debug.Log("count < equipData.prefabPath.Count,count:" + ccount + ",equipData.prefabPath.Count:" + equipData.prefabPath.Count + ",equip:" + currentEquip.id);
        //    yield return null;
        //}
        //isEquipingWeapon = false;
		//Debug.Log("end equip done:" + currentEquip.id);
        //yield break;
        //}
    }
    ...
    {
		//Debug.Log("InstanceLoaded");
		//Debug.Log("ActorParent.InstanceLoaded()");
    ...
    {
		//Debug.Log("SwitchWeaponPos(isInCopy=" + isInCopy + ")");
		//Debug.Log(EQUIP_TAP, "SwitchWeaponPos");
        //while (isEquipingWeapon)
        //{
        //    yield return null;
        //}
        //isEquipingWeapon = true;
		//Debug.Log("SwitchWeaponPos!!!!!");
        if (this == null)
        {
			Debug.Log("SwitchWeaponPos this == null!");
			//Debug.Log("SwitchWeaponPos this == null!");
            //isEquipingWeapon = false;
            yield break;
        }
        ...
        if (isInCopy)
        {
            ...
            {
				Debug.Log("weaponData.slot == null!");
                yield break;
            }
        ...
        else
        {
            ...
            {
				Debug.Log("weaponData.slotInCity == null!");
                yield break;
            }
        ...
        {
			Debug.Log("weaponData.prefabPath.Count != slots.Count");
			Debug.Log("weaponData.prefabPath.Count:" + weaponObj.Count);
			Debug.Log("slots.Count:" + slots.Count);
			Debug.Log("weaponData.id:" + m_weaponData.id);
			//Debug.Log("weaponData.prefabPath.Count != slots.Count");
            //isEquipingWeapon = false;
            yield break;
        }
        ...
        {
			//Debug.Log("weaponObj[i].name:" + weaponObj[i].name + ",slot[i]" + slots[i]);
            ChangeEquipPosition(weaponObj.Get(i), slots.Get(i));
        }
		//Debug.Log("SwitchWeaponPos done!!!!!");
