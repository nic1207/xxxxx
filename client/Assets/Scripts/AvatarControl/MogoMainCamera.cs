...
public class MogoMainCamera : MonoBehaviour
{
    ...
    {
        //Debug.Log("m_animStarTime:" + m_animStarTime);
        //Debug.Log("Time.time:" + Time.time);
        //Debug.Log("deltaTime:" + (Time.time - m_animStarTime) * 1000);
    ...
    public void CloseToTarget(Transform _target, float distance, float rotationY, float rotationX, float _moveTime, float _rotateTime, Action OnDone = null)
    {
        ...
        if (CurrentState != CLOST_TO_TARGET)
        {
            //Debug.Log("CloseToTarget:" + _target.name + ",distance:" + distance + ",rotationY:" + m_rotationY + ",rotationX:" + m_rotationX + ",_moveTime:" + _moveTime + ",_rotateTime:" + _rotateTime);
    ...
    public void PlayVictoryCG()
    {
        ...
        if (parent == null)
        {
            Debug.LogError("can not find " + data.Path);
            return;
        } 
