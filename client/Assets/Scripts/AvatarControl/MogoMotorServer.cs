...
public class MogoMotorServer : MogoMotor
{
    ...
    /// <summary>d
    /// ����animatorĿ���ٶȣ�motor����acceleration����
    /// �����ܲ�ֹͣ�����ں�
    /// </summary>
    /// <param name="_speed"></param>
    public override void SetSpeed(float _speed)
    {
        ////Debug.Log("setSpeed:" + _speed);
        moveSpeed = _speed;
    ...
    void Update()
    {
        ...
        if (isMovingToInATime)
        {
            ...
            //Debug.Log("Time.time - moveTimeBegin:" + (Time.time - moveTimeBegin));
    ...
    float targetZ = 0;
    float targetX = 0;
    int lastFrameDirection = 0;//0�ޣ�1234ǰ������
