...
public class FriendManager
{
    ...
    {
        //Debug.Log("FriendManager::ReqFriendReqList");
        myself.RpcCall(ON_FRIENDREQ_LIST);
    }

    public void AcceptFriendReq(TDBID DbID)
    {
        Debug.Log("AcceptFriendReq : id" + DbID);
    ...
    {
        Debug.Log("SendFriendNote : id" + DbID + "  context : " + context);
    ...
    */
    public void OnFriendRecvNoteResp(LuaTable luatable)
    {
        ...
        {
            Debug.LogError("OnFriendRecvNoteResp");
            return;
        }
        foreach (FriendMessageGridData fd in m_friendList)
        {
    ...
    {
        Debug.Log("FriendAddReqResp :" + msg);

    }

    public void FriendDelResp(int msg)
    {
        Debug.Log("FriendDelResp : " + msg);
    ...
    {
        Debug.Log("FriendAcceptResp:" + msg);
        //if (ERROR_FRIEND_SUCCESS == msg)
            //ReqFriendList();
    }
    ...
    {
        Debug.Log("FriendRejectResp: " + msg);
    }
    ...
    public void FriendSendNoteResp(int msg)
    {
        ...
        Debug.Log("FriendSendNoteResp:" + msg);
    }
