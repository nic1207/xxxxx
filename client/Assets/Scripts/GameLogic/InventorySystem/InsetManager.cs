...
public class InsetManager
{
    ...
    {
        Debug.Log("OnJewelSlotSelect:" + index);
    ...
    {
        Debug.Log("OnInsetEquipGridUp:" + (index + 1));
    ...
    {
        Debug.Log("DisassembleJewel:" + idx);
        int jewelId = (m_inventoryManager.EquipOnDic[CurrentSlot].jewelSlots)[idx];
        m_currentJewelData = ItemJewelData.dataMap[jewelId];
    ...
    private bool CanJewelInset(int index)
    {
        ...
        //    return false; ;
        //}
        //Debug.Log("m_currentSlot:" + CurrentSlot);
    ...
    {
        Debug.Log("insetManager ui refresh!");
    ...
    private void RefreshDialog1UI()
    {
        ...
        if (m_inventoryManager.EquipOnDic.ContainsKey(CurrentSlot))
        {
            ...
            {
                //Debug.Log("item.id:" + item.templateId);
                for (int i = 0; i < item.jewelSlotsType.Count; i++)
                {
                    if (item.jewelSlotsType[i] <= 0) continue;
                    //Debug.Log("item.jewelSlotsType[i]:" + item.jewelSlotsType[i]);
            ...
            //Debug.Log("m_currentJewelSlot:" + m_currentJewelSlot);
            if (item.jewelSlots != null)
            {
                for (int i = 0; i < item.jewelSlots.Count; i++)
                {
                    ...
                    {
                        Debug.Log("view.SetJewelSlotCurrentDown(i);" + i);
    ...
    {
        Debug.Log("JewelInlayIntoEqiResp:" + errorId);
    ...
    {
        Debug.Log("JewelOutlayResp:" + errorId);
    ...
    {
        Debug.Log("JewelCombineInEquiResp:" + errorId);
