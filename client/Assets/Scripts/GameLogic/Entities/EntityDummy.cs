...
namespace Mogo.Game
{
    public class EntityDummy : EntityParent
    {
        ...
        public override void CreateActualModel()
        {
            ...
            SubAssetCacheMgr.GetCharacterInstance(data.prefabName,
                (prefab, guid, gameObject) =>
                {
                    ...
                    //Debug.LogError("RebornAnimationDelay" + waitTime);
        ...
        public override void Think(AIEvent triggerEvent)
        {
            ...
            if (canThinkError != 0)
            {
                //Mogo.Util.Debug.LogError("canThinkError:" + canThinkError + " AIEvent" + triggerEvent + " ID:" + ID);
                return;
            }
        ...
        {
            //Debug.LogError("RebornAnimationDelay end");
