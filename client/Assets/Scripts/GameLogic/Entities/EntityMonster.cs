    ...
    public class EntityMonster : EntityParent
    {
        ...
        public UInt32 monsterId
        {
            ...
            set
            {
                ...
                //Debug.LogError("m_monsterId " + m_monsterId + "m_difficulty" + m_difficulty);
                //Debug.LogError("m_monsterData " + m_monsterData.hpBase + " curHp:" + curHp);
                //Debug.LogError("ogoWorld.thePlayer.sceneId " + MogoWorld.thePlayer.sceneId);
                //Debug.LogError("MogoWorld.thePlayer.ApplyMissionID == 42000 ? MogoWorld.thePlayer.level : 0 = " + (MogoWorld.thePlayer.sceneId == 42000 ? (int)m_difficulty : 0));
            }
        }
        ...
        public byte factionFlag
        {
            ...
            {
                m_factionFlag = value;
                Debug.Log("kevin factionFlag Mon:" + m_factionFlag);
            }
        }
