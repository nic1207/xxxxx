    ...
    public class EntityAccount : EntityParent
    {
        ...
        public LuaTable avatarsInfo
        {
            set
            {
				...
				//Debug.Log("avatarList.Count=" + avatarList.Count);
            }
        }
        /// <summary>
        /// avatarsInfo转换后实体数据
        ...
        {
			Debug.Log("CreateCharacter() vocation: " + vocation);
            m_currentName = name;
        ...
        {
			//Debug.Log("OnDelCharacterResp( " + errorID + ", " + characterID+")");
            CharaterInfoReq();
        }
        ...
        private void OnCharaterInfoResp(LuaTable luaTable)
        {
            ...
            UpdateCharacterList();
			//Debug.Log("OnCharaterInfoResp( " + luaTable+")");
        }
        ...
        {
			//Debug.Log ("OnCheckVersionResp(" + errorID+")");
            switch (errorID)
            {
                case 1:
					//Debug.Log("OnCheckVersionResp(Compatible Version)");
                    // MogoGlobleUIManager.Instance.Info("Compatible Version");
                    break;
                case 2:
					//Debug.Log("OnCheckVersionResp(Incompatible Version)");
        ...
        {
			//Debug.Log("CheckVersionReq(" + VersionManager.Instance.LocalVersion.ToString()+")");
