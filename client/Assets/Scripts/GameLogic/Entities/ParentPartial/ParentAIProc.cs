...
namespace Mogo.Game
{
    public partial class EntityParent
	{
        ...
        public virtual bool IsPatrolCD() //{ Debug.Log("par:IsPatrolCD"); return false; }
        {
        ...
        public virtual bool ProcPatrol(int CDTimeMin, int CDTimeMax)// { Debug.Log("par:ProcPatrol"); return false; }
        {
        ...
        public virtual bool IsAngerFull() { Debug.Log("par:IsAngerFull"); return false; }//怒气已满

        public virtual bool IsPowerFX() { Debug.Log("par:IsPowerFX"); return false; }//是暴气状态

        public virtual bool PowerFX() { Debug.Log("par:PowerFX"); return false; }//进入暴气状态
        

        public virtual bool NotTurn() { Debug.Log("par:NotTurn"); return false; }
        public virtual void Think(AIEvent triggerEvent) { Debug.Log("par:Think"); return; }
        public virtual bool ProcMercenaryAOI() { Debug.Log("par:ProcMercenaryAOI"); return false; }
        public virtual bool ProcPVPAOI() { Debug.Log("par:ProcPVPAOI"); return false; }
        public virtual bool ProcChooseCastPoint(int skillBagIndex) { Debug.Log("par:ProcChooseCastPoint"); return false; }
        //public virtual void ProcMoveTo() { Debug.Log("par:ProcMoveTo"); }
        //public virtual void ProcThink() { Debug.Log("par:ProcThink"); }
        //public virtual void ProcEnterRest(uint sec) { Debug.Log("par:ProcEnterRest"); }
        //public virtual void ProcEnterCD(int sec) { Debug.Log("par:ProcEnterCD"); }
        public virtual bool ProcCastSpell(int skillBagIndex, int reversal) { Debug.Log("par:ProcCastSpell"); return false; }
        //public virtual void ProcReinitLastCast() { Debug.Log("par:ProcProcReinitLastCastLastCastIs"); }
        public virtual bool ProcInSkillRange(int skillBagIndex) { Debug.Log("par:ProcInSkillRange"); return false; }
        public virtual bool ProcInSkillCoolDown(int skillBagIndex) { Debug.Log("par:ProcInSkillCoolDown"); return false; }
        public virtual bool ProcLastCastIs(int skillBagIndex)
        {
            skillBagIndex--;
            return (blackBoard.lastCastIndex == skillBagIndex) ? true : false;
        }
        public virtual int GetEnemyNum() { Debug.Log("par:GetEnemyNum"); return 0; }

        
        //public virtual void ProcEscape(uint sec) { Debug.Log("par:ProcEscape"); return; }
        //public virtual void ProcLookOn() { Debug.Log("par:ProcLookOn"); return; }
        ...
        public virtual bool ProcFollowOwner() { Debug.Log("par:ProcFollowOwner"); return false; }
        public virtual bool ProcSelectAutoFightMovePoint() { Debug.Log("par:ProcSelectAutoFightMovePoint"); return false; }
