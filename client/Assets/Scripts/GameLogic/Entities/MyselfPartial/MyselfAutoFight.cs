    ...
    public partial class EntityMyself
    {
        ...
        public bool LockMove
        {
            ...
            set
            {
                ...
                {//这里肯定是服务器下发
                    ...
                    //Debug.Log("LockMove:" + m_bLockMove);
        ...
        public int WaitTrapEnd
        {
            ...
            set
            {
                ...
                if (value == 0)
                {
                    //Debug.Log("m_bWaitTrapEnd = 0   0");
                    m_bWaitTrapEnd = 0;
                    if (LockMove)
                        return;
                    //Debug.Log("m_bWaitTrapEnd = 0   1");
                    ...
                    //Debug.Log("111" + tarKey + " " + m_iGuideProgress + " " + totleCorners + " " + MissionPathPointData.missionPathPoint[tarKey - 1].isNormalType);
        ...
        public AutoFightState AutoFight
        {
            ...
            set
            {
                ...
                {
                    Debug.Log("AutoFight 1:" + m_iAutoFightState);
                    LockMove = false;
                ...
                else
                {
                    ...
                    //Debug.Log("AutoFight 2:" + m_iAutoFightState);
                    Think(AIEvent.AvatarPosSync);
                }
        ...
        public int ProgressPointIndex
        {
            ...
            set
            {
                ...
                //Debug.Log("ProgressPointIndex 0:" + m_iProgressPointIndex);
            }
        }

        private void DummyThink()
        {
            //Debug.LogError("dummy  AvatarPosSync");
            if (AutoFight != AutoFightState.RUNNING)
                return;
        ...
        public void ProcCGBegin()
        {
            ...
            if (AutoFight == AutoFightState.RUNNING)
            {
                //Debug.Log("ProcCGBegin 3");
                //Debug.Log("ProcCGBegin");
        ...
        public void ProcTrapBegin(string gearType)
        {
            ...
            //Debug.Log("*************************************  TrapBegin   " + Transform.position + " " + gearType);
        ...
        private void PathPointTrigger(int triggerKey)
        {
            ...
            //Debug.Log("PathPointTrigger 0:" + (MissionPathPointData.missionPathPoint[triggerKey - 1].isEnable == 1) +
            ...
            if ((MissionPathPointData.missionPathPoint[triggerKey - 1].isEnable == 1) ||
                (MissionPathPointData.missionPathPoint[triggerKey - 1].isNormalType == 1))
                return;
            //Debug.Log("PathPointTrigger 0:" + triggerKey + " " + (MissionPathPointData.missionPathPoint[triggerKey - 1].isEnable == 1) +
            //    (MissionPathPointData.missionPathPoint[triggerKey - 1].isNormalType == 1));
            //更新副本进度到服务器
            ...
            //此点设置为关闭
            //Debug.Log("PathPointTrigger 2.1" + m_iGuideProgress + triggerKey);
            ...
            {
                //Debug.Log("333:" + triggerKey + " " + m_iGuideProgress + " " + totleCorners);
                if (m_iGuideProgress == totleCorners)
                { //踩到是最后一个corner，让指针消失,一般最后一个点都不会是传送门，所以最后点只写在这锪侍
            ...
            if (AutoFight == AutoFightState.RUNNING)
            {
                if (MissionPathPointData.missionPathPoint[triggerKey - 1].isNormalType == 2)
                {
                    ...
                    //Debug.LogError("22222222222222222222222222222222222222222222");
                    //踩在电梯点,走到电梯延伸点
        ...
        private void DirActive()
        {
            ...
            {
                //Debug.Log("Dir 1:" + MogoWorld.CGing + " " + MogoWorld.hasMonster + " " + MogoWorld.touchLastPathPoint + " " + MogoWorld.thePlayer.isInCity + " " + !MogoWorld.canAutoFight + " " + MogoWorld.connoning);
                MogoFXManager.Instance.DisatblePointerToTarget();
            }
            else
            {
                //Debug.Log("Dir 2:" + MogoWorld.CGing + " " + MogoWorld.hasMonster + " " + MogoWorld.touchLastPathPoint + " " + MogoWorld.thePlayer.isInCity + " " + !MogoWorld.canAutoFight + " " + MogoWorld.connoning);
        ...
        public override void Think(AIEvent triggerEvent)
        {
            ...
            //Debug.Log("aiId:" + m_iAiId + "  event:" + triggerEvent);
            ...
            if (blackBoard.enemyId <= 0)
            {
                ...
                foreach (KeyValuePair<Transform, Container> pair in Container.containers)
                {
                    ...
                    {//目标还没被打烂
                        ...
                        Debug.LogError("old hit trap:" + blackBoard.enemyTrap.transform.position);
                        return true;
                    }
                     */
                    if (pair.Value.triggleEnable && (pair.Value is Crock || pair.Value is Chest))
                    {
                        //Debug.Log("(((((((((((((( " + pair.Value.gameObject.name);
                ...
                {
                    //Debug.LogError("want hit trap:" + blackBoard.enemyTrap.transform.position);
                    return true;
                }
                else
                {
                    //Debug.LogError("no hit trap");
                    return false;
                }
            }
            else
        ...
        public override bool ProcInSkillCoolDown(int skillBagIndex)
        {
            ...
            {
                //Debug.Log("nSkillCoolDown:" + skillBagIndex + " " + skillid + " false");
                return false;
            }
            else
            {
                //Debug.Log("nSkillCoolDown:" + skillBagIndex + " " + skillid + " true");
                return true;
            }
        }
        ...
        public override bool ProcCastSpell(int skillBagIndex, int reversal)
        {
            ...
            switch (skillBagIndex)
            {
                ...
                case 4:
                    {
                        //Debug.Log("SpellOneAttack:" + skillBagIndex);
                        ((PlayerBattleManager)battleManger).SpellOneAttack();
                    }
                    break;
                case 5:
                    {
                        //Debug.Log("SpellTwoAttack:" + skillBagIndex);
                        ((PlayerBattleManager)battleManger).SpellTwoAttack();
                    }
                    break;
                case 6:
                    {
                        //Debug.Log("SpellThreeAttack:" + skillBagIndex);
        ...
        public override bool ProcInSkillRange(int skillBagIndex)
        {
            ...
            if (distance >= curdistance)
            {
                ...
                rnt = true;
                //Debug.Log("IsInSkillRange:true");
            }
            else
            {
                rnt = false;
                //Debug.Log("IsInSkillRange:false");
            }

            //Debug.Log("inskillrange:" + skillBagIndex + " " + rnt + "    " + distance + " vs " + curdistance + " :" + (distance >= curdistance));
        ...
        public override bool ProcSelectAutoFightMovePoint()
        {
            ...
            //Mogo.Util.Debug.LogError("ProcSelectAutoFightMovePoint " + debugcount++);
            int totleCorners = MissionPathPointData.missionPathPoint.Length;
            float minDis = 9999.0f;
            ...
            if (ProgressPointIndex == -1)
            {
                ...
                {
                    //Debug.Log("111 7");
                    //Debug.Log("******************:" + ProgressPointIndex +  "  priid:" + MissionPathPointData.missionPathPoint[ProgressPointIndex - 1].preID +  " count:" + debugcount++);
                    ...
                    //Debug.Log("------------------:" + ProgressPointIndex + " count:" + debugcount++);
            ...
            {
                //Debug.LogError("old:" + ProgressPointIndex);
                ...
                {//继续走此路点   
                    // Debug.Log("go on:" + ProgressPointIndex);
                    tarPoint = new Vector3(tmpTarPoint.x, Transform.position.y, tmpTarPoint.y);
                    hasGetPoint = true;
                }
            ...
            if (hasGetPoint)
            {
                ...
                //Debug.Log("tarPoint:" + tarPoint + " ProgressIndex:" + ProgressPointIndex);
        ...
        public void UpdateAutoFightInfo()
        {
            if (MogoWorld.canAutoFight)
            {
                ...
                if (weaponType != 0)
                {
                    ...
                    //Debug.LogError("normalOneSkillId" + normalOneSkillId + " reflectNormalComboSkillId:" + m_iNormalAttackCastSkillId);
                    switch (vocation)
                    {
