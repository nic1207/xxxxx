    ...
    public partial class EntityMercenary : EntityParent
    {
        ...
        public override void CreateModel()
        {
            ...
            if (clientTrapId == 0)
            {
                if (m_monsterId > 0)
                {
                    //Mogo.Util.Debug.LogError("CreateModel:MogoWorld.thePlayer.ApplyMissionID" + MogoWorld.thePlayer.ApplyMissionID + " dif:" + (MogoWorld.thePlayer.ApplyMissionID == Mogo.Game.RandomFB.RAIDID ? MogoWorld.thePlayer.level : (int)m_difficulty));
                ...
                else
                {
                    ...
                    {
                        //tmpSkills.Add(2061);
                        //Mogo.Util.Debug.LogError("tmpSkills.Add:" + (int)args[i]);
        ...
        */
        public void CreatePlayerActualModel()
        {
            ...
            SubAssetCacheMgr.GetPlayerInstance(data.prefabName,
                (prefab, guid, go) =>
                {
                    ...
                    //Debug.LogError("RebornAnimationDelay begin:" + waitTime);
        ...
        {
            //Debug.Log("m_loadedCuirass" + m_loadedCuirass + " " + m_loadedArmguard + " " + m_loadedLeg + " " + loadedWeapon);
            ...
            {
                //Debug.Log("id:" + dbid);
                //Debug.Log("load weapon:" + loadedWeapon);
        ...
        public override void CreateActualModel()
        {
            ...
            if (data == null)
            {
                Debug.LogError("Model not found: " + m_monsterData.model);
                return;
            }
        ...
        override public void OnDeath(int actionID)
        {
                ...
                && ID != MogoWorld.theLittleGuyID)
            {
                ...
                {
                    //Debug.LogError("Entity fadeout 1");
        ...
        {
            //Debug.Log("dummy  AvatarPosSync", false, 1);
        ...
        private void DummyStiffEnd(GameObject g)
        {
            ...
            if (g == Transform.gameObject)
            {
                ...
                //Debug.Log("dummy  DummyStiffEnd", false, 1);
        ...
        private void ProcessWarnOtherSpawnPointEntities(uint eid, byte AIWarnEvent, uint targetEid, int spawnPointCfgId)
        {
            switch (AIWarnEvent)
            {
                case (byte)Mogo.Game.AIWarnEvent.DiscoverSomeOne:
                    ...
                    {
                        //Debug.LogError("Other Guy EditHatred:" + targetEid);
        ...
        {
            //Debug.Log("dummy  ProcessBossDie", false, 1);
            if (m_factionFlag == 0)
            {//是怪物则要死
