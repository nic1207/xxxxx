...
public class GMManager
{
    ...
    private void ProcGM(string cmd)
    {
        ...
        else if (cmds[0] == "@ShowGuide")
        {
            ...
            Debug.Log(MogoUIQueue.Instance.m_listUI.PackList('\n'));
        }
        ...
        else if (cmds[0] == "@RFC")
        {
            ...
            Debug.LogWarning("current reference count" + '\n' + rfc);
        }
        ...
        {
            Debug.Log(AssetCacheMgr.ResourceDic.PackMap(mapSpriter: '\n'));
        }
        else if (cmds[0] == "@PGONM")
        {
            Debug.Log(AssetCacheMgr.GameObjectNameMapping.PackMap(mapSpriter: '\n'));
        }
