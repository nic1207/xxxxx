...
public class DragonMatchData
{
    ...
    public uint matchTimeLeft
    {
        get
        {
            //Debug.Log("time:" + MogoTime.Instance.GetSecond());
...
public class DragonMatchManager
{
    ...
    {
        //Debug.Log("RemainConvoyTimesResp:" + times);
    ...
    public void ShowMainUI()
    {
        ...
        if (m_currentData.playerList != null)
        {
            ...
            {
                //Debug.Log(m_currentData.playerList[i].name);
        ...
        MogoUIManager.Instance.ShowDragonMatchUI(
                   () =>
                   {
                       //Debug.Log("onShowDragonMatchUI done");
                       ...
                       //Debug.Log("m_currentData.hitCD:" + (int)m_currentData.hitCD);
    ...
    {
        Debug.Log("OnBuyDragonResp:" + errorId + "," + quality);
        //刷新选龙界面
        if (errorId == 0)
        {
            m_currentData.dragonQuality = quality;
    ...
    {
        Debug.Log("StartDragonConvoyReq");
        //请求比赛数据
    ...
    public void EventListAvatarNameResp(LuaTable luatable)
    {
        ...
        Debug.Log("SetUIGridList");
        DragonMatchRecordUIViewManager.Instance.SetUIGridList(m_RecordViewData.Count, () =>
        {
            Debug.Log("SetUIGridList done");
            Debug.Log("m_RecordViewData.size:" + m_RecordViewData.Count);
            //for (int i = 0; i < m_RecordViewData.Count; i++)
            //{
            //    Debug.Log(m_RecordViewData[i].info);
            //    Debug.Log(m_RecordViewData[i].hasRevenged);
            //    Debug.Log(m_RecordViewData[i].needTip);
            //    Debug.Log(m_RecordViewData[i].canRevenge);
            //}
            DragonMatchRecordUIViewManager.Instance.SetGridListData(m_RecordViewData);
            Debug.Log("revengeTime:" + m_currentData.revengeTime);
    ...
    {
        Debug.Log("OnAttackOtherPlayer:" + m_selectedPlayer);
        //请求袭击其他玩家
    ...
    {
        Debug.Log("ClearAtkCdResp:" + errorId);
    ...
    public void DragonRelatedResp(byte errorId)
    {
        ...
        Debug.Log("DragonRelatedResp:" + errorId);
        switch (errorId)
        {
    ...
    {
        Debug.Log("FreshConvoyRewardResp:" + exp + "," + gold);
    ...
    {
        Debug.Log("DragonConvoyResp:" + errorId + ",timeleft:" + timeLeft);
        if (errorId == 0)
        {
    ...
    {
        Debug.Log("ExploreDragonEventResp:" + errorId);
        if (errorId == 0)
        {
