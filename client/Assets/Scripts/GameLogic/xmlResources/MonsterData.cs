...
namespace Mogo.GameData
{
    public class MonsterData : GameData<MonsterData>
    {
        ...
        static public MonsterData GetData(int id, int monsterDifficulty = 0)
        {
            ...
            //if (id == 42201) Mogo.Util.Debug.LogError("GetData start:" + id + " monsterDifficulty:" + monsterDifficulty);
            MonsterData dst = dataMap[id];
            //if (id == 42201) Mogo.Util.Debug.LogError("GetData 1.1:" + id);
            if (!dst.loadedExtraData)
            {
                //if (id == 42201) Mogo.Util.Debug.LogError("GetData 1.2:" + id);

                if (AvatarModelData.dataMap.ContainsKey(dst.model))
                {
                    //if (id == 42201) Mogo.Util.Debug.LogError("GetData 1.3:" + id);
                ...
                //if (id == 42201) Mogo.Util.Debug.LogError("GetData 2:" + id + " dst.monsterType:" + dst.monsterType);
                foreach (MonsterValueData child in MonsterValueData.dataMap.Values)
                {
                    ...
                    {
                        //if (id == 42201) Mogo.Util.Debug.LogError("GetData 3:" + id + " hpBase" + child.hpBase + " atkb:" + child.attackBase);
                        ...
                        //if (id == 42201) Mogo.Util.Debug.LogError("GetData:" + id + " raidId:" + child.raidId + " child.difficulty:" + child.difficulty + " monsterType:" + child.monsterType + " hpBase:" + child.hpBase);
                ...
                { 
                    ...
                    //if (id == 42201) Mogo.Util.Debug.LogError("MonsterValue Loaded Failed monsterId:" + id);
                }
            }
            ...
            else
            {
                ...
                {
                    //if (id == 42201) Debug.LogError("old ram:" + dataMap[rid].hpBase);
                    return dataMap[rid];
                }
                else
                {
                    ...
                    foreach (MonsterValueData child in MonsterValueData.dataMap.Values)
                    {
                        if ((!(dst.monsterType >= 5 && dst.monsterType <= 8) && child.raidId == Mogo.Game.RandomFB.RAIDID && child.difficulty == monsterDifficulty && child.monsterType == dst.monsterType) ||
                            (dst.monsterType >= 5 && dst.monsterType <= 8 && child.monsterType == dst.monsterType))
                        {
                            //Mogo.Util.Debug.LogError("GetData 3:" + id + " hpBase" + child.hpBase + " atkb:" + child.attackBase);
                            ...
                            //Mogo.Util.Debug.LogError("Random:" + id + " raidId:" + child.raidId + " child.difficulty:" + monsterDifficulty + " monsterType:" + child.monsterType + " hpBase:" + child.hpBase);
                            //Debug.LogError("new ram:" + ranDst.hpBase);
                            break;
                        }
                    }
        ...
        {
            //Debug.LogError("monsterId" + monsterId + " vocation:" + vocation);
            ...
            if (tmpCfgData.equ != null && tmpCfgData.equ.Count > 0)
                ...
                {
                    //Debug.LogError("subCfgData equ:" + subCfgData.Key + "  " +  subCfgData.Value);
            ...
            if (tmpCfgData.extraRandom != null && tmpCfgData.extraRandom.Count > 0)
                ...
                {
                    //Debug.LogError("subCfgData extraRandom:" + subExtraRandom.Key + "  " + subExtraRandom.Value);
                    //Debug.LogError("subCfgData extraDrop:" + tmpCfgData.extraDrop[subExtraRandom.Key]);
                ...
                RandomHelper.GetRandomInt(10000) < tmpCfgData.goldChance)
            {
                ...
                //Debug.LogError("awardGold" + awardGold +" "+ tmpCfgData.gold[0] + " " +tmpCfgData.gold[1]);
            ...
            {
                //Debug.LogError("want getDrop item:" + subDstDropsItem.Key + " num:" + subDstDropsItem.Value);
            }
            foreach (int money in tblDstMoney)
            {
                //Debug.LogError("want getDrop money:" + money);
            }
        }
    }
}
