...
public class DoorOfBurySystem
{
    ...
    {
        //Debug.Log("OnCloseToDoor");
        //todo ��������֮��ʱ
    }

    //private void OnBossDead()
    //{
    //    Debug.Log("OnBossDead");
    //    //todo boss���˺���ʾ
    //}
    ...
    {
        //Debug.Log("OblivionGateListResp:" + cd);
        CD = (int)cd;
