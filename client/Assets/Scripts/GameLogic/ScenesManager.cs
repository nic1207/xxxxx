...
namespace Mogo.Game
{
    public class ScenesManager : IEventManager
    {
        ...
        private IEnumerator UnloadUnusedAssets(Action callBack)
        {
            //while (true)
            //{
            //Debug.LogError("begin UnloadUnusedAssets");
            yield return Resources.UnloadUnusedAssets();
            //Debug.LogError("end UnloadUnusedAssets");
            callBack();
            //    yield break;
            //}
        }
        ...
        public void SwitchLightMapFog(int sceneId, Action<Boolean> loaded)
        {
            ...
            {
                Debug.LogError("MapData not exist: " + sceneId);
                if (loaded != null)
                    loaded(false);
            }
        }
