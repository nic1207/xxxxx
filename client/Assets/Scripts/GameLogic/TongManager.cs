...
public class TongManager
{
    ...
    const UInt16 ERROR_GET_DRAGON_NOT_FULL = 56;  //公会处于冻结状态中，能接受申顷松    const UInt16 ERROR_GET_DRAGON_OVER_TIMES = 57;  //公会处于冻结状态中，不能接受邀请
    ...
    public const byte MSG_DEMISE = 56;      //馍√
    ...
    */
    ...
    {
        Debug.Log(gridID + " " + m_listTongMemberData.Count + " @@@@@@@@@@@@@@@@@@@@@@@");
