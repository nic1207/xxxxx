...
namespace Mogo.Util
{
    ...
    public class TCPClientWorker
    {
        ...
        public TCPClientWorker()
        {
            ...
            {
				//LoggerHelper.Debug("TCPClientWorker() init AsynSend");
            ...
            {
				//LoggerHelper.Debug("TCPClientWorker() Start AsynSend: " + m_asynSendSwitch);
                m_sendThread.Start();
            }
        }
        ...
        public void Connect(string IP, int Port)
        {
            lock (m_tcpClientLocker)
            {
                ...
                {
                    throw new Exception("the tcpClient has Connectted.");
                }
                ...
                {
                    throw new Exception("the tcpClient do connecting error." + e);
                }
            }
        }
